...
public class ChangePasswordActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if(v==btnOk)
        {
            ...
            if(etOldPass.getText().toString().trim().equalsIgnoreCase("")){
            ...
            }else if(etCnfPass.getText().toString().trim().equalsIgnoreCase("")){
               ...
               UtilMethods.INSTANCE.changePassword (this, etOldPass.getText().toString().trim(), etCnfPass.getText().toString().trim(),
                            loader,this);
